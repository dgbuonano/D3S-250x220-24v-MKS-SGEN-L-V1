...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  92.7
  #define DEFAULT_bedKi  7.44
  #define DEFAULT_bedKd 770.66
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 1600, 138.33 }
 ...
 */
#define DEFAULT_ACCELERATION          9001    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  9000  // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   9001    // X, Y, Z acceleration for travel (non printing) moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28.7, 6.5 , -2.4}
...
#define Z_PROBE_FEEDRATE_FAST (1500) //#define Z_PROBE_FEEDRATE_FAST (1000)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST/3) //#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 30)
...
#define HOMING_FEEDRATE_MM_M { (1500), (1500), (1500) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS + 0), 0 }
