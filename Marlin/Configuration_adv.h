...
//
  ...
  #define BED_CHECK_INTERVAL 500   //5000 // (ms) Interval between checks in bang-bang control
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  75, 75 }, { (250-75),  75 }, { (250-75), (235-75) }, { 75, (235-75) } }
...
//
  ...
  #define DGUS_UPDATE_INTERVAL_MS  100    // (ms) Interval between automatic screen updates
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #define DOUBLECLICK_MAX_INTERVAL 10000   // Maximum interval between clicks, in milliseconds.
